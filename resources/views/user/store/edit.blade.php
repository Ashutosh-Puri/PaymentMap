    ...
    <div class="row w-100 m-0">
        <div class="col m-0 p-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store.update', $store->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            @if ($store->store_photo)
                                <div class="col-4 col-md-2 py-1">
                                    ...
                                    <br><a class="btn btn-danger w-100" href="{{ url('remove/img/'.$store->id.'/1') }}">Remove </a>
                                </div>
                            @endif
                            @if ($store->store_qr)
                                <div class="col-4 col-md-2 py-1 text-center">
                                    ...
                                    <br><a class="btn btn-danger w-100" href="{{ url('remove/img/'.$store->id.'/2') }}">Remove </a>
                                </div>
                            @endif
                            <div class="row mb-0">
